...
| USB connector path | `J1`, `R1`, `D1`, `C2` | `SOFNG USB-05`, USB-side resistors, `USBLC6-2SC6`, and VBUS-side bulk/input capacitance | Keep the connector decision explicit and the protection close to the connector |
