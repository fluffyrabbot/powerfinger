...
- All-severity ERC warning cleanup; current snapshot lives in
  ...
  state: ERC=36 warnings / 0 errors, PCB DRC=0, unconnected=0, parity=0)
...
- KiCad CLI ERC and PCB DRC remain clean at error severity after local
  footprint/library loading; all-severity PCB DRC is also clean with 0
