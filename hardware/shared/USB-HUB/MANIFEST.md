...
- Cleared ERC plus library-hygiene cleanup; current snapshot lives in
  ...
  state: ERC=50, DRC=27, unconnected=0, parity=0 — all DRC items are
  footprint library provenance, not routing)
