...
assemble_first_sweep() {
...

    {
        ...
        printf '\nTransfer only real observations back into the lane worksheets and packet docs; this generated first-sweep folder is a print-queue-ready subset, not measured evidence.\n'
