...
|---|---|---|---|
| Optical ring | `hardware/ring/R30-OLED-NONE-NONE/` | DFM/pre-fab review, BOM costability review, assembly/serviceability feedback, and quote once PCB DRC is closed | BOM-backed packet and first routed rigid P0 source exist; KiCad snapshot is still red: ERC=0, PCB DRC=51, unconnected=9, parity=0 |
